...
<body class="reports-page" onload="loadfarefunction(); loadtripsfunction()">
	<?php include_once("layouts/dashboard.n;avigation.php") ?> 
...
// COLUMN CHART
    ...
    //     success: function (response) {
    //         totaladminactive = response["totalactive"];

    //         // TO DO: EXTRACT VALUE, SET TO VARIABLES
    //         driverstats();
    //     },
    //     error: function (response) {
    //       $("#result").removeClass();
    //       $('#result').addClass('alert alert-danger');
    //       $('#result').html("Error Message: " + response.responseText);
    //     },
    //     contentType: "application/json; charset=UTF-8",
    //     dataType: "json"
    //   });
...
//         error: function (response) {
//           // $("#avgbasefare").removeClass();
//           // $('#avgbasefare').addClass('alert alert-danger');
//           // $('#avgbasefare').html("Error Message: " + response.responseText);
//         },
//         contentType: "application/json; charset=UTF-8",
//         dataType: "json"
//       });
